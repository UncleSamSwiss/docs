...
__Note:__ This project runs an application in a single container. If you would like to start with a [multicontainer project][multi-project], run `git clone https://github.com/resin-io-projects/multicontainer-getting-started.git`.
